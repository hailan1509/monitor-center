...
export function App() {
    ...
    return (_jsxs("main", { className: "layout", children: [showLoading ? (_jsx("div", { className: "global-loading-overlay", role: "status", "aria-live": "polite", "aria-label": "Loading", children: _jsxs("div", { className: "global-loading-card", children: [_jsx("div", { className: "spinner" }), _jsx("div", { className: "global-loading-text", children: "Loading\u2026" })] }) })) : null, _jsxs("aside", { className: "sidebar", children: [_jsxs("div", { className: "brand", children: [_jsx("div", { className: "brand-mark", children: "MC" }), _jsxs("div", { className: "brand-text", children: [_jsx("div", { className: "brand-title", children: "Monitor Center" }), _jsx("div", { className: "brand-subtitle", children: "Logs & Observability" })] })] }), _jsx("nav", { className: "menu", children: navSections.map((section) => (_jsxs("div", { className: "menu-section", children: [_jsx("div", { className: "menu-section-title", children: section.title }), _jsx("div", { className: "menu-section-items", children: section.keys
                                        .filter((key) => (key === "team" ? user.role === "admin" : true))
                                        .map((key) => {
                                        const item = navItems.find((candidate) => candidate.key === key);
                                        if (!item)
                                            return null;
                                        return (_jsxs("button", { type: "button", className: nav === item.key ? "menu-item active" : "menu-item", onClick: () => setNav(item.key), children: [_jsx("span", { className: "menu-item-icon", children: navIcons[item.key] }), _jsx("span", { className: "menu-item-label", children: item.label })] }, item.key));
